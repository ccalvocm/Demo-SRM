...
def DEVELOP_SRM(root, Basin, alpha, Tcrit, plots):
    ...
    if plots:
        ...
        # SWe observado
        # swe_obs = pd.read_csv(r'E:\CIREN\OneDrive - ciren.cl\Of hidrica\AOHIA_ZC\Etapa 3\Scripts\outputs\GEE_downloads\Mataquito\RTDJCC\Mataquito_RTDJCC_bandas_ERA5hourly_SWE_2000_2021_simplify_0_05.csv', index_col = 0, parse_dates = True)
        swe_obs = pd.read_csv(r'C:\Users\ccalvo\OneDrive - ciren.cl\Of hidrica\AOHIA_ZC\Etapa 3\Scripts\outputs\GEE_downloads\Mataquito\RTDJCC\Mataquito_RTDJCC_bandas_ERA5hourly_SWE_2000_2021_simplify_0_05.csv', index_col = 0, parse_dates = True)
        swe_obs_day = swe_obs.resample('D').mean()
        swe_obs_day.iloc[:,-2] = swe_obs_day.iloc[:,-3]
