...
def Prepare_MODIS(Package,Year,prjpath):

    import os # OK

    Year=str(Year) # OK
    rawmodis = Package + '/Datos/NASA_Datos/MODIS/' + Year # OK
    readymodis = rawmodis + '/prm' # OK
    reprojmodis = readymodis + '/reproj'
    ...
    Project_Filelist(project_list,prjpath,reprojmodis,False,False,Quiet=False)
...
def Project_Filelist(filelist,prjpath,outdir=False,resampling_type=False,cell_size=False,Quiet=False):
