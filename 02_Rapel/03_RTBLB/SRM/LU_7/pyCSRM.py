...
def DEVELOP_SRM(root, Basin, alpha, Tcrit, plots):
    ...
    if plots:
        ...
        # SWe observado
        swe_obs = pd.read_csv(r'C:\Users\ccalvo\OneDrive - ciren.cl\Of hidrica\AOHIA_ZC\Etapa 3\Scripts\outputs\GEE_downloads\Rapel\RTBLB\Rapel_RTBLB_bandas_ERA5hourly_SWE_2000_2021_simplify_0_05.csv', index_col = 0, parse_dates = True)
...
if __name__ == '__main__':
    root = '.'
    Basin = 'Tinguiririca_Los_Briones'
